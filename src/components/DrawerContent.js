...
const drawers = [
  { title: "Reward Profile", icon: "reward_profile_drawer", routeName: "StackReward" },
  { title: "Transactions", icon: "transaction_drawer", routeName: "Transactions" },
  ...
  { title: "About HarmonyPay", icon: "about_harmony_pay_drawer", routeName: "About" },
      ...
      {data.map((item, index) => {
        return (
          <DrawerItem
            ...
            icon={() => <DrawerIcon source={ICONS[item.icon]} style={styles.icon} />}
            label={item.title}
