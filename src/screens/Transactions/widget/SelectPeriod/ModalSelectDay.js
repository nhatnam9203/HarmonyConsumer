...
export default class ModalSelectDay extends Component {
  constructor(props) {
    super(props);
  ...
  renderItemsFilter = () => {
    ...
    return filter_data.map((obj, index) => (
      <TouchableOpacity
        ...
        {obj.isCheck ? (
          <Image style={styles.icon} source={images.check_box} />
        ) : (
          <Image style={styles.icon} source={images.check_box_empty} />
        )}
      </TouchableOpacity>
    ));
  };
