...
import { Text, Container, Form, Header, ProgressiveImage, LazyImage } from "components";
...
export default function index(props) {
  ...
  const {
    template: { type, imageUrl, giftCardTemplateId, fileId, giftCardType, giftCardTemplateName },
  } = props.route.params;
  ...
  const goToSelectCreditCard = () => {
    let gift = {
      ...
      giftCardTemplateName: type == "template_custom" ? "Your Template" : giftCardTemplateName,
    };
    ...
    <Container barStyle="dark-content">
      ...
      <View style={styles.container_center}>
        ...
        {type == "template_custom" ? (
          <CustomTemplate onSubmit={submitImage} images={images} onChangeImage={setImage} />
        ) : (
        ...
        <View style={styles.button_submit}>
          <ButtonSubmit
            ...
            title="Next"
            width={370}
            disabled={amount == 0 || (type == "template_custom" && !images.uri) ? true : false}
            backgroundColor={
              amount == 0 || (type == "template_custom" && !images.uri) ? "#EEEEEE" : "#0764B0"
            }
            textColor={
              amount == 0 || (type == "template_custom" && !images.uri) ? "#585858" : "#FFF"
            }
          />
        </View>
      </View>
